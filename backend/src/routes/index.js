...
router.post('/sessions/:sessionId/reconnect', sessionController.reconnectSession); // Reconnect disconnected session

// Session Assignments
router.post('/sessions/:sessionId/assign', isAdmin, validateAssignSession, sessionController.assignSession);
router.get('/sessions/:sessionId/assignments', sessionController.getSessionAssignments);
router.delete('/sessions/:sessionId/assignments/:assignmentId', isAdmin, sessionController.unassignSession);
